...
form_image_window = uic.loadUiType("equalizationWindow.ui")[0]

class equalizationWindow(QDialog,QWidget,form_image_window):

    def __init__(self):
        super(equalizationWindow,self).__init__()
        self.initUI()
        self.show()
